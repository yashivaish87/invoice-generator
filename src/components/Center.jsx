                ...
                <motion.div
                    ...
                    <div className=' min-w-full max-h-[64px] flex items-center justify-between'>
                        ...
                        <div className=' flex  max-h-full  items-center '>
                            ...
                            <button onClick={() => setOpenCreateInvoice(true)} className=' hover:opacity-80 ml-4 md:ml-10 flex items-center py-2 px-2 md:space-x-3 space-x-2 dark:bg-gray-800 bg-sky-100 rounded-full'>
                                <img src={plus} alt="" />
                                <p className=' md:block hidden text-[#656fff] font-semibold text-lg'>New invoice</p>
                                <p className=' md:hidden block text-[#656fff] font-semibold text-base'>New</p>
                            </button>
