...
function InvoiceInfo({ onDelete }) {
    ...
    return (
        <div>
            ...
            {isDeleteModalOpen && invoice && ( <DeleteModal onDeleteButtonClick={onDeleteButtonClick} setIsDeleteModalOpen={setIsDeleteModalOpen} invoiceId={invoice.id} />)}
            <AnimatePresence>
                {isEditOpen && invoice && (<CreateInvoice invoice={invoice} type='edit' setOpenCreateInvoice={setIsEditOpen} />)}
            </AnimatePresence>
        </div>
    )
}
